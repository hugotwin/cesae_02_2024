...
/**
 * Classe arqueiro que  herda da classe Heroi
 */
public class Arqueiro extends Heroi {
     ...
     * @param armaPrincipal
     */
    public Arqueiro(int VALOR_INICIAL_VIDA, String nome, int forca, int nivel, int ouro, ArmaPrincipal armaPrincipal) { //!falta definir a ama principal ArmaPrincipal armaPrincipal
                        ...
                        switch (opcao) {
                            ...
                            case 2:
                                ...
                                if (!ataque_esqpecial) {
                                    ...
                                    System.out.println(Cores.BG_BLUE);
                                    System.out.println("--------------ATAQUE ESPECIAL DO HERÓI-------------");
                                    npc.setVidaAtual_hp(npc.getVidaAtual_hp() - this.getForca() - getArmaPrincipal().getAtaqueEspecial());
                                    System.out.println("Vida do Herói ->" + this.getVidaAtual_hp());
                                    System.out.println(("Vida do Inimigo ->" + npc.getVidaAtual_hp()));
                                    System.out.println("---------------------------------------------------------");
                                    running=false;
                                    opcao_correta = true;
