...
if con == None: #erro ao tentar fazer a conexão
    ...
    #Entry
    enomebd = Entry(jan1, font=fonte1)
    ...
    def criar_bd():
        ...
        ##Interface 2
        #ocultar a 1ª janela
        #jan1.iconify() #minimiza na barra de tarefas
        jan1.withdraw() #faz desaparecer a janela.... não está disponível na barra de tarefas
        ...
        def criar_tab():
            ...
            jan2.destroy() #destroi a janela 2
            jan1.deiconify() #volta a mostrar a janela 1
    ...
    blimpar = Button(jan1, text="Limpar", font=fonte, command=lambda:enomebd.delete(0,END))

    #mostrar objetos gráficos no contentor JAN1
    texto.pack()
    enomebd.pack()
    botao.pack()
    blimpar.pack()
