...
def insert_product():
    nome = entry_nome_admin.get()
    preco = entry_preco_admin.get()
    quantidade = entry_quantidade_admin.get()
    ...
    query = "INSERT INTO artigos (nome, preco, quantidade) VALUES (%s, %s, %s)"
...
create_user_window.title("Login")
create_user_window.withdraw()

tk.Label(create_user_window, text="Novo usuário:").grid(row=0, column=0)
entry_new_username = tk.Entry(create_user_window)
entry_new_username.grid(row=0, column=1)
tk.Label(create_user_window, text="Senha:").grid(row=1, column=0)
entry_new_password = tk.Entry(create_user_window, show="*")
entry_new_password.grid(row=1, column=1)
entry_new_tipo_utilizador= tk.Entry(create_user_window, show="*")
entry_new_tipo_utilizador.grid(row=2, column=1)
tk.Button(create_user_window, text="Login", command=create_user).grid(row=2, column=0, columnspan=2)
...
entry_nome_admin = tk.Entry(frame)
entry_nome_admin.grid(row=0, column=1)

tk.Label(frame, text="Preço:").grid(row=1, column=0)
entry_preco_admin = tk.Entry(frame)
entry_preco_admin.grid(row=1, column=1)

tk.Label(frame, text="Quantidade:").grid(row=2, column=0)
entry_quantidade_admin = tk.Entry(frame)
entry_quantidade_admin.grid(row=2, column=1)
...
tk.Button(frame, text="Novo Utilizador", command=create_user).grid(row=3, column=3)
...
entry_nome_user = tk.Entry(user_window)
entry_nome_user.grid(row=0, column=1)

tk.Label(user_window, text="Preço:").grid(row=1, column=0)
entry_preco_user = tk.Entry(user_window)
entry_preco_user.grid(row=1, column=1)

tk.Label(user_window, text="Quantidade:").grid(row=2, column=0)
entry_quantidade_user = tk.Entry(user_window)
entry_quantidade_user.grid(row=2, column=1)
