...
const jobCode = Number(prompt("Enter the job code (101 for Manager, 102 for Engineer, 103 for Technician):"));
let newSalary;
switch (jobCode) {
    case 101: // Manager
...
let difference = newSalary - salary;
let message = "Old salary: " + salary + "\nNew salary: " + newSalary + "\nDifference: " + difference;
alert(message);
